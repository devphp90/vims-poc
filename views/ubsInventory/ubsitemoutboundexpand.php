...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
    ...
    'type'=>'striped',
    'dataProvider' => $model->boundsearch(),
    'summaryText'=>'',
    'columns' => 
    array(
    	array(
...
/*
		array(
			'header'=>"",
			'type'=>'raw',
			'value'=>'$data->total_sup_count." total<br/>".$data->sup_count." in stock<br/>".$data->total_supplier_exclude." excluded by price diff"',
		),
*/
		array(
...
$cs->registerScript('#defaultjs', "$('.tbrelational-column').trigger('click');");
?>
