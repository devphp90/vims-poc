...
$this->menu=array(
	...
	array('label'=>'Delete All', 'url'=>'#', 'linkOptions'=>array('submit'=>array('deleteAllMisMatch?id='.$supplier->id),
...
<?php if ($supplier): ?>
<h1>MisMatch Records for Supplier: <?= $supplier->name; ?></h1>
<?php else: ?>
<h1>MisMatch Records for ALL Suppliers</h1>
<?php endif; ?>
