...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'dataProvider'=>$model->searchNoMatch(),
	'ajaxUpdate'=>false,
	'filter'=>$model,
	...
	'columns'=>array(
		...
		array(
			'type'=>'raw',
			'value'=>'CHtml::link("Accept",array("/supInventory/create","new_id"=>$data->id))',
		),
		array(
			'type'=>'raw',
			'value'=>'CHtml::ajaxLink("Recovery",array("/supNewItem/updateStatus","id"=>$data->id,"value"=>0),array("success"=>"function(){ $.fn.yiiGridView.update(\'sup-new-item-grid\');}"))',
		),
