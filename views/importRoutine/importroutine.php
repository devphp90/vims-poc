...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'type'=>'raw',
			'value'=>'\'<a target="_blank" href="manualImport?id=\'.$data->id.\'">Upload File</a>\'',
		),
		array(
			'header'=>'Run Import Now',
			'type'=>'raw',
			'value'=>'\'<a target="_blank" href="get?id=\'.$data->id.\'&id2=\'.$data->id2.\'">Import Now</a>\'',
		),
		array(
			'header'=>'View Import Log',
			'type'=>'raw',
			'value'=>'CHtml::link(\'Import Log\',array(\'/logs/importlogview\',\'id\'=>$data->id),array())',
		),
