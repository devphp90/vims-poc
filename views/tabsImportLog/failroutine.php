...
$this->widget('bootstrap.widgets.TbExtendedGridView',array(
  ...
  'columns'=>array(
      ...
      array(
          ...
          'value'=> 'CHtml::link("Action", "#", array("data-toggle" => "modal","data-target"=>"#myModal", "tabs_id" => $data->tabs_id, "tabs_import_log_id" => $data->id, "class" => "user-action"))'
...
//    ),
    ...
    array(
      ...
      //'name'=>'create_time',
        'type' => 'raw',
      'value'=> 'CHtml::link($data->tab->supplier->name, Yii::app()->createUrl("tabs/update", array("id" => $data->tabs_id)))',
    ...
    array(
        ...
        'value' => 'CHtml::link("Run I/U",array("/importRoutine/triggleIU","id"=>$data->tabs_id))',
