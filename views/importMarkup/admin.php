...
//	array('label'=>'Search/Filter','url'=>'#','linkOptions'=>array('class'=>'search-button')),
	...
	array('label'=>'Update DB After Markup Change', 'url'=>array('updateAll')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('import-markup-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Sell Price Markup Rule, Global Level</h1>
