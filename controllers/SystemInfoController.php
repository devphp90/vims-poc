...
class SystemInfoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SystemInfo');
	...
	{
		$model=new SystemInfo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SystemInfo']))
			$model->attributes=$_GET['SystemInfo'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='system-info-form')
		{
