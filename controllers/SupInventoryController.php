...
class SupInventoryController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('importSeedSheet','import','create','update','admin','delete','dashboard','dropItem','supview','openOrderInbound','ajaxSupstatus','supStat','supupdate','ajaxMultiItemStatus','index','view','clean', 'changeStatus'),
				'users'=>array('@'),
			),
	...
	public function actionChangeStatus()
	{
		if(isset($_REQUEST['id']) && Yii::app()->request->isAjaxRequest) {
			...
			$model->item_status = !$model->item_status;
			$model->save(false);
...
//          $model->ubs_id       = UbsInventory::model()->bySku($item[2])->find()->id;
	...
	public function actionDashboard()
	{
		...
		$this->render('//dashboard/supInventory_dashboard',array(
			'model'=>$model,
		));
	}
	...
	public function actionAdmin()
	{
		...
		$this->render('//dashboard/supplier_items_status',array(
			'model'=>$model,
