	...
	public function accessRules()
	{
		return array(
			array('allow',
				...
				'ips'=>array('64.202.107.200','64.202.107.201','64.202.107.202','108.168.227.66'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('ajaxStatus','create','update','admin','delete','start','fetchColumn','ajaxsup','ajaxsheet','routineControl','get','manual','dashboard','importsheet','manualImport','importRoutine','updateroutine','getPartialSheet','testconnection','retrieveSheet','getimportUrl','getcsv','index','view','updateFile','newUpdateFile','import','triggleIU'),
				'users'=>array('@'),
			),
...
echo 'wget --delete-after -q '.$importUrl.' > /dev/null ;'.'wget --delete-after -q '.$updateUrl.' > /dev/null &';
