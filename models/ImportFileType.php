...
/**
 * This is the model class for table "{{import_file_type}}".
 *
 * The followings are the available columns in table '{{import_file_type}}':
 * @property integer $id
 * @property string $type
 */
class ImportFileType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImportFileType the static model class
	 */
