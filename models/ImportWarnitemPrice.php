...
/**
 * This is the model class for table "{{import_warnitem_price}}".
 *
 * The followings are the available columns in table '{{import_warnitem_price}}':
 * @property integer $id
 ...
 */
class ImportWarnitemPrice extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImportWarnitemPrice the static model class
	 */
