...
//		$this->registerAssetCss('bootstrap' . (!YII_DEBUG ? '.min' : '') . '.css');
		Yii::app()->getClientScript()->registerCssFile('//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/css/bootstrap-combined.min.css');
	}
	...
	public function registerJS($position = CClientScript::POS_HEAD)
	{
		...
		$cs->registerScriptFile('//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/js/bootstrap.min.js', $position);
	}
